...
:: Android packaging
set AND_CERT_NAME="OpenIAB-air"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OpenIABair.p12
...
set IOS_PROVISION=cert\OpenIABair.mobileprovision
...
set APP_ID=air.OpenIABair

:: Output packages
set DIST_PATH=dist
set DIST_NAME=OpenIABair
